...
import com.madrefoca.cafe_tango.fragments.SchoolsTab1;
import com.madrefoca.cafe_tango.fragments.SchoolsTab2;
import com.madrefoca.cafe_tango.fragments.SchoolsTab3;
...
public class SchoolsViewPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        {
            SchoolsTab1 tab1 = new SchoolsTab1();
            return tab1;
        } else if (position == 1) {
            SchoolsTab2 tab2 = new SchoolsTab2();
            return tab2;
        } else             // As we are having 2 tabs if the position is now 0 it must be 1 so we are returning second tab
        {
            SchoolsTab3 tab3 = new SchoolsTab3();
            return tab3;
        }
